    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          User.findByEmail(email, /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(err, results) {
              var hashedPassword;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 6:
                    ...
                    User.create(name, email, hashedPassword, function (err, result, confirmationCode) {
                      if (err) {
...
exports.verify = function (req, res) {
  ...
  User.activateUser(confirmationCode, function (err, result) {
    if (err) {
      return res.status(500).send({
...
exports.login = function (req, res) {
  ...
  User.findByEmail(email, function (err, results) {
    if (err) {
      return res.status(500).send({
    ...
    bcrypt.compare(password, user.contrasena, function (err, match) {
      if (err) {
        return res.status(500).send({
